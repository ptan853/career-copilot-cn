...
import { getEvents, updateEvent, confirmEvent, archiveEvent, uploadSource, ingestMultiSource, getJob, getProfile, createEvent } from '@/lib/api-client'
...
export default function ProfilePage() {
  ...
  // Add a blank new section — 先创建后端记录再打开弹窗
