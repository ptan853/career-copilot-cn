...
SECTION_BY_EVENT_TYPE = {
    ...
    "award": ProfileSection("awards", "奖项"),
    "competition": ProfileSection("awards", "奖项"),
    "certification": ProfileSection("certifications", "证书/课程"),
    "course": ProfileSection("certifications", "证书/课程"),
