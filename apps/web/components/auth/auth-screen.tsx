      ...
      <section className="relative border-b border-[#e4edf7] bg-[linear-gradient(135deg,#f9fcff_0%,#eefcff_42%,#f7fbff_72%,#fff7f2_100%)]">
        ...
        <div className="mx-auto grid max-w-[1280px] grid-cols-1 gap-12 px-5 pb-20 pt-14 lg:grid-cols-[0.95fr_1.05fr] lg:px-8 lg:pb-24 lg:pt-20">
          <div className="flex flex-col items-start">
            <div className="inline-flex items-center gap-2 rounded-full border border-[#d6eef8] bg-white/75 px-4 py-2 text-sm font-bold text-[#2563eb] shadow-[0_10px_24px_rgba(59,130,246,0.08)]">
            ...
            <p className="mt-6 max-w-[690px] rounded-[16px] border border-[#dceefa] bg-white/62 px-5 py-4 text-xl font-bold leading-8 text-[#2563eb] shadow-[0_16px_36px_rgba(15,23,42,0.05)]">
              路漫漫其修远兮，吾将上下而求索。
            </p>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <button
                ...
                className="inline-flex h-14 items-center justify-center gap-3 rounded-[12px] bg-[#3b82f6] px-8 text-base font-extrabold text-white shadow-[0_18px_34px_rgba(59,130,246,0.25)] transition hover:bg-[#2563eb]"
              >
                开始整理我的经历
      ...
      <section id="workflow" className="bg-white px-5 py-20 lg:px-8">
        <div className="mx-auto max-w-[1280px]">
          <div className="text-center">
            <p className="text-sm font-black tracking-[0.16em] text-[#3b82f6]">从经历资料到职业身份层</p>
          ...
          <div className="mt-14 grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
            {[
              ['第一步', '统一输入', '简历、岗位 JD、项目记录、面试复盘都进入同一个输入框。', UploadCloud, 'bg-[#eaf6ff] text-[#2563eb]'],
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {[
              ...
              <article key={title as string} className="rounded-[20px] border border-[#e3eef8] bg-white/90 p-6 shadow-[0_18px_50px_rgba(15,23,42,0.055)]">
                <div className="grid h-11 w-11 place-items-center rounded-[14px] bg-[#eaf6ff] text-[#3b82f6]">
    ...
    <header className="sticky top-0 z-30 border-b border-[#e4edf7] bg-white/78 backdrop-blur-xl">
      <div className="mx-auto flex h-[76px] max-w-[1280px] items-center justify-between px-5 lg:px-8">
        ...
        <nav className="hidden items-center gap-9 text-base font-bold text-[#5c6f8a] lg:flex">
          <a href="#features" className="inline-flex items-center gap-1 hover:text-[#3b82f6]">
            产品能力 <ChevronDown className="h-4 w-4" />
          </a>
          <a href="#workflow" className="hover:text-[#3b82f6]">工作流</a>
          <a href="#features" className="hover:text-[#3b82f6]">国内岗位</a>
          <a href="#features" className="hover:text-[#3b82f6]">关于我们</a>
        </nav>
        ...
        <div className="flex items-center gap-3">
          {checkingUser ? (
            ...
            <>
              <a
                href="/dashboard"
                className="hidden h-11 items-center justify-center rounded-[12px] bg-[#3b82f6] px-5 text-sm font-extrabold text-white shadow-[0_12px_26px_rgba(59,130,246,0.24)] transition hover:bg-[#2563eb] sm:inline-flex"
              >
                进入工作台
              </a>
              <div className="relative">
                ...
                >
                  <span className="grid h-7 w-7 shrink-0 place-items-center rounded-full bg-[#e8f3ff] text-xs font-black text-[#3b82f6]">
                    {avatarLabel}
                  </span>
            ...
            <button
              ...
              className="inline-flex h-11 items-center justify-center rounded-[12px] bg-[#3b82f6] px-5 text-sm font-extrabold text-white shadow-[0_12px_26px_rgba(59,130,246,0.24)] transition hover:bg-[#2563eb]"
            >
              登录 / 注册
            </button>
          )}
...
function HeroProductMockup() {
  return (
    <div className="relative mx-auto w-full max-w-[620px] lg:mt-8">
      <div className="rounded-[30px] border border-white/80 bg-white/78 p-3 shadow-[0_34px_90px_rgba(59,130,246,0.16)] backdrop-blur">
        <div className="rounded-[24px] border border-[#e3eef8] bg-[#fbfdff]">
          ...
          <div className="grid gap-4 p-5">
            <div className="rounded-[20px] border border-dashed border-[#b7d9f5] bg-white p-4 shadow-[0_14px_28px_rgba(15,23,42,0.04)]">
              <div className="flex items-center gap-3">
                <div className="grid h-11 w-11 place-items-center rounded-[15px] bg-[#eaf6ff] text-[#3b82f6]">
            ...
            {[
              ...
              ['项目', 'AI 简历评估器', '识别到 3 个量化指标', FolderKanban, 'bg-[#eaf6ff] text-[#2563eb]'],
            ...
            <button
              type="button"
              className="flex items-center justify-center gap-2 rounded-[16px] border border-[#dbe8f5] bg-white px-4 py-3 text-sm font-black text-[#3b82f6] shadow-sm"
            >
      ...
      <div className="absolute -bottom-5 -left-5 hidden rounded-[20px] border border-[#e3eef8] bg-white px-5 py-4 shadow-[0_18px_40px_rgba(59,130,246,0.13)] md:block">
...
function AuthModal(props: {
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-[#eef7ff]/82 px-4 py-8 backdrop-blur-sm">
      <div className="relative w-full max-w-[520px] rounded-[28px] border border-white/85 bg-white p-8 shadow-[0_30px_80px_rgba(59,130,246,0.18)] md:p-10">
        <button
          type="button"
        ...
        <div className="mb-7">
          <div className="mb-5 inline-flex items-center gap-3 text-sm font-black tracking-[0.08em] text-[#3b82f6]">
          ...
          {(['login', 'signup'] as AuthMode[]).map(authMode => (
            <button
              ...
              className={`h-10 rounded-[8px] text-sm font-black transition ${
                props.mode === authMode ? 'bg-white text-[#3b82f6] shadow-sm' : 'text-[#60708a] hover:text-[#24364f]'
              }`}
            >
        ...
        <div className="flex h-10 items-center gap-2 rounded-[12px] bg-[#eaf6ff] px-3 text-sm font-black text-[#3b82f6]">
        ...
        <div className="mt-5 space-y-4">
          ...
          <button
            ...
            className="h-[52px] w-full rounded-[14px] bg-[#3b82f6] px-4 py-3.5 text-base font-black text-white shadow-[0_14px_30px_rgba(59,130,246,0.22)] transition hover:bg-[#2563eb] disabled:cursor-not-allowed disabled:bg-[#eef3f8] disabled:text-[#60708a]"
          >
            {isSignup ? '创建账号' : '登录'}
          </button>
        </div>
        ...
        <div className="mt-7 text-center text-base font-semibold text-[#60708a]">
          ...
          <button
            ...
            className="font-black text-[#3b82f6] hover:text-[#2563eb]"
          >
            {isSignup ? '去登录' : '去注册'}
          </button>
        </div>
...
function Field({ icon, children }: { icon: React.ReactNode; children: React.ReactNode }) {
  return (
    <div className="flex h-14 items-center gap-3 rounded-[14px] border border-[#dbe8f5] bg-white px-4 text-[#8a9bb2] focus-within:border-[#3b82f6] focus-within:ring-4 focus-within:ring-[#3b82f6]/10">
      {icon}
      {children}
    </div>
  )
